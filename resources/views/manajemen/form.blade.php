<!-- Modal tambah member -->
<div class="modal fade" id="tambahUserModal" tabindex="-1" role="dialog" aria-labelledby="modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <form id="tambahUserForm" action="{{ route('user.store') }}" method="POST" class="form-horizontal">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" id="nama_user" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
